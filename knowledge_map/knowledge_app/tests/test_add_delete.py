...
class AddDeleteNodeTest(TestCase):
    ...
    def test_add_node_creates_topic_node(self):
        ...
        self.assertEqual(TopicNode.objects.filter(knowledge_map=self.knowledge_map).count(), 1)
    ...
    def test_delete_node_returns_success(self):
        ...
        response = self.client.post(reverse('delete_node', args=[self.knowledge_map.id, node.id]))
        data = json.loads(response.content)
        self.assertTrue(data['success'])

    def test_delete_nonexistent_node_returns_404(self):
        """Deleting a node that doesn't exist should return 404."""
        response = self.client.post(reverse('delete_node', args=[self.knowledge_map.id, 9999]))
        self.assertEqual(response.status_code, 404)
    ...
    def test_delete_node_get_request_returns_405(self):
        ...
        response = self.client.get(reverse('delete_node', args=[self.knowledge_map.id, node.id]))
        self.assertEqual(response.status_code, 405)
...
class AddDeleteRelationshipTest(TestCase):
    ...
    def test_add_relationship_creates_node_relationship(self):
        ...
        self.assertEqual(NodeRelationship.objects.filter(knowledge_map=self.knowledge_map).count(), 1)
    ...
    def test_add_relationship_get_request_returns_405(self):
        ...
        response = self.client.get(reverse('add_relationship', args=[self.knowledge_map.id]))
        self.assertEqual(response.status_code, 405)
    ...
    def test_delete_relationship_removes_from_database(self):
        ...
        self.client.post(reverse('delete_relationship', args=[self.knowledge_map.id, relationship.id]))
    ...
    def test_delete_relationship_returns_success(self):
        ...
        response = self.client.post(
            reverse('delete_relationship', args=[self.knowledge_map.id, relationship.id])
        )
        data = json.loads(response.content)
        self.assertTrue(data['success'])
