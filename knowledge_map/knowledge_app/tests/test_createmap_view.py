...
def test_post_rejects_file_belonging_to_other_user(self):
    ...
    def test_post_creates_knowledge_map_record(self, mock_task):
        ...
        response = self.client.post(
            reverse("create_map"),
            {"file_id": self.uploaded_file.id, "title": "My Test Map"},
        )
    ...
    def test_post_with_invalid_file_id_returns_404(self):
        ...
        response = self.client.post(
            reverse("create_map"), {"file_id": 9999, "title": "My Test Map"}
        )
        self.assertEqual(response.status_code, 404)
